...
To quit monitoring, press <span class="title-ref">Ctrl-c</span> and you'll be returned to the VyOS command
prompt.
...
VyOS 1.2 uses [Debian Jessie](https://www.debian.org/releases/jessie/) as the base Linux operating system. Jessie was
the first version of Debian that uses [systemd](https://freedesktop.org/wiki/Software/systemd/) as the default init system.
...
5.  The service file launches the VyOS router init script
    `/usr/libexec/vyos/init/vyos-router` - this is part of the [vyatta-cfg](https://github.com/vyos/vyatta-cfg)
    Debian package

> 1.  Starts [FRR](https://frrouting.org/) - successor to [GNU Zebra](https://www.gnu.org/software/zebra/) and [Quagga](https://www.quagga.net/)
