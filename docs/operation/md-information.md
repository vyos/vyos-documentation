...
server connected but in addition also a serial backed `wwan-interface`.
...
If a device is unplugged and re-plugged it will receive a new
...
device name displayed, e.g. <span class="title-ref">usb0b2.4p1.0</span> can be directly used when accessing
