...
in the [README.md](https://github.com/vyos/vyos-documentation/blob/master/README.md) to build and test your changes.

You can either install Sphinx (and TeX Live for PDF output) and build the
documentation locally, or use the [Dockerfile](https://github.com/vyos/vyos-documentation/blob/master/docker/Dockerfile) to build it in a container.
...
Take a look at the `/documentation` page for an intricate explanation
of the documentation process.

The following is a quick summary of the rules:

- Use American English at all times. It's always a good idea to run
  your text through a grammar and spell checker, such as [Grammarly](https://www.grammarly.com/).
...
- Make all your changes - please keep our commit rules in mind
  (`prepare_commit`). This mainly applies to proper commit messages
  describing your change (how and why). Please check out the documentation of
  [Sphinx-doc](https://www.sphinx-doc.org) or [reStructuredText](http://www.sphinx-doc.org/en/master/usage/restructuredtext/index.html) if you are not familiar with it. This is used
  for writing our docs. Additional directives how to write in RST can be
  obtained from [reStructuredTextDirectives](https://docutils.sourceforge.io/docs/ref/rst/directives.html).
...
- Check your changes by locally building the documentation `$ make livehtml`.
  ...
  [README.md](https://github.com/vyos/vyos-documentation/blob/master/README.md) file of this repository.
...
- Once pull requests have been approved, you may want to locally update
  ...
  called <span class="title-ref">upstream</span> which points to our main repository. `$ git remote add upstream https://github.com/vyos/vyos-documentation.git`
...
Note the following RFCs (`5737`, `3849`, `5389` and
`7042`), which describe the reserved public IP addresses and autonomous
