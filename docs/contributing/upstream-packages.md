...
1.  <span class="title-ref">cd vyos-strongswan</span>
2.  <span class="title-ref">./configure --enable-python-eggs</span>
3.  <span class="title-ref">cd src/libcharon/plugins/vici/python</span>
4.  <span class="title-ref">make</span>
5.  <span class="title-ref">python3 setup.py --command-packages=stdeb.command bdist_deb</span>
