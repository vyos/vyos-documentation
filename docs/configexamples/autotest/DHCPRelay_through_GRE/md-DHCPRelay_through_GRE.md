...
the DHCP Relay is a GRE tunnel. The <span class="title-ref">transport</span> VyOS represent a large
Network.

![Ansible Example topology image](_include/topology.webp)
...
<span id="include">include</span>/transport.conf

</div>

DHCP-Server

<div class="literalinclude" language="none" lines="1-8">

<span id="include">include</span>/dhcp-server.conf
...
<span id="include">include</span>/dhcp-relay.conf
...
<div class="literalinclude" language="none" lines="9-13">
...
<div class="literalinclude" language="none" lines="9-10">
