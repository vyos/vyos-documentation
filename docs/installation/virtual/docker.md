...
I: generate OCI container image vyos-1.5.1-oci-amd64.tar
I: to import the previously generated OCI image to your local images run:

   docker import vyos-1.5.1-oci-amd64.tar vyos:1.5.1 --change 'CMD ["/sbin/init"]'
```
...
$ ./vyos-build/scripts/iso-to-oci vyos-1.5.1-generic-amd64.iso
```
...
```none
$ docker import vyos-1.5.1-oci-amd64.tar vyos:1.5.1 \
