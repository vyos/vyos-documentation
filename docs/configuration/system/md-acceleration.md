...
At the moment only [Intel® QAT](https://www.intel.com/content/www/us/en/architecture-and-technology/intel-quick-assist-technology-overview.html) is supported
...
with `set system acceleration qat` on both systems the bandwidth
increases.
