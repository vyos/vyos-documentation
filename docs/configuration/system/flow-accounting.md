...
Using `IMT (In-Memory Table)` may lead to heavy CPU overloading and
...
identified by <span class="title-ref">\<interface\></span>.
...
There are multiple versions available for the NetFlow data. The <span class="title-ref">\<version\></span>
...
Configure address of NetFlow collector. NetFlow server at <span class="title-ref">\<address\></span> can
...
system samples one in every <span class="title-ref">\<rate\></span> packets, where <span class="title-ref">\<rate\></span> is the value
...
Using <span class="title-ref">system sflow</span> is recommended in favor of
<span class="title-ref">system flow-accounting</span>. See [sflow](sflow.html)
...
Configure address of sFlow collector. sFlow server at <span class="title-ref">\<address\></span> can
...
Show flow accounting information for given <span class="title-ref">\<interface\></span>.
...
Show flow accounting information for given <span class="title-ref">\<interface\></span> for a specific host
only.
