...
The system LCD `LCD (Liquid-crystal display)` option is for users running
...
(<span class="title-ref">ttySxx</span>) or serial via USB or even old parallel port interfaces.
...
type is missing, please create a feature request via [Phabricator]().
