...
set policy route-map \<text\> rule \<1-65535\> match community
community-list \<text\>
...
set policy route-map \<text\> rule \<1-65535\> match extcommunity
\<text\>
...
set policy route-map \<text\> rule \<1-65535\> match ip address
access-list \<1-2699\>
...
set policy route-map \<text\> rule \<1-65535\> match ip nexthop
access-list \<1-2699\>
...
set policy route-map \<text\> rule \<1-65535\> match ip route-source
access-list \<1-2699\>
...
set policy route-map \<text\> rule \<1-65535\> match ipv6 address
access-list \<text\>
...
set policy route-map \<text\> rule \<1-65535\> match origin
\<egp[|igp|](##SUBST##|igp|)incomplete\>
...
set policy route-map \<text\> rule \<1-65535\> match rpki
\<invalid[|notfound|](##SUBST##|notfound|)valid\>
...
set policy route-map \<text\> rule \<1-65535\> match source-vrf \<text\>
...
set policy route-map \<text\> rule \<1-65535\> set as-path exclude
\<1-4294967295 | all\>
...
set policy route-map \<text\> rule \<1-65535\> set as-path prepend
\<1-4294967295\>
...
set policy route-map \<text\> rule \<1-65535\> set as-path
prepend-last-as \<n\>
...
set policy route-map \<text\> rule \<1-65535\> set community
...
set policy route-map \<text\> rule \<1-65535\> set community none
...
set policy route-map \<text\> rule \<1-65535\> set community delete
\<text\>
...
set policy route-map \<text\> rule \<1-65535\> set large-community none
...
set policy route-map \<text\> rule \<1-65535\> set large-community delete
\<text\>
...
\<1-25600[|cumulative|](##SUBST##|cumulative|)num-multipaths\>
...
set policy route-map \<text\> rule \<1-65535\> set extcommunity bandwidth-non-transitive
...
set policy route-map \<text\> rule \<1-65535\> set extcommunity rt
\<text\>
...
set policy route-map \<text\> rule \<1-65535\> set extcommunity soo
\<text\>
...
set policy route-map \<text\> rule \<1-65535\> set extcommunity none
...
set policy route-map \<text\> rule \<1-65535\> set ip-next-hop
\<x.x.x.x\>
...
set policy route-map \<text\> rule \<1-65535\> set ipv6-next-hop
...
set policy route-map \<text\> rule \<1-65535\> set local-preference
\<0-4294967295\>
...
set policy route-map \<text\> rule \<1-65535\> set metric
\<+/-metric[|0-4294967295|](##SUBST##|0-4294967295|)rtt[|+rtt|](##SUBST##|+rtt|)-rtt\>
...
set policy route-map \<text\> rule \<1-65535\> set metric-type
\<type-1|type-2\>
...
set policy route-map \<text\> rule \<1-65535\> set origin
\<igp[|egp|](##SUBST##|egp|)incomplete\>
...
set policy route-map \<text\> rule \<1-65535\> set originator-id
\<x.x.x.x\>
...
set policy route-map \<text\> rule \<1-65535\> set src
...
set policy route-map \<text\> rule \<1-65535\> set weight
\<0-4294967295\>
