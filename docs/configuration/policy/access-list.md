...
set policy access-list \<acl_number\> rule \<1-65535\> action
\<permit|deny\>
...
set policy access-list \<acl_number\> rule \<1-65535\>
\<destination[|source\> \<any|](##SUBST##|source> <any|)host[|inverse-mask|](##SUBST##|inverse-mask|)network\>
...
set policy access-list6 \<text\> rule \<1-65535\> source
\<any[|exact-match|](##SUBST##|exact-match|)network\>
