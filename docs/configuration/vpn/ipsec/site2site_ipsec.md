...
set vpn ipsec authentication psk \<name\> dhcp-interface
...
set vpn ipsec authentication psk id \<id\>
...
set vpn ipsec authentication psk secret \<secret\>

A predefined shared secret used in configured mode
`pre-shared-secret`. Base64-encoded secrets are allowed if
<span class="title-ref">secret-type base64</span> is configured.

</div>

<div class="cfgcmd">

set vpn ipsec authentication psk secret-type \<type\>
...
set vpn ipsec site-to-site peer \<name\> authentication mode \<mode\>
...
set vpn ipsec site-to-site peer \<name\> authentication local-id \<id\>
...
set vpn ipsec site-to-site peer \<name\> authentication remote-id \<id\>
...
set vpn ipsec site-to-site peer \<name\> authentication rsa local-key \<key\>
...
set vpn ipsec site-to-site peer \<name\> authentication rsa remote-key \<key\>
...
set vpn ipsec site-to-site peer \<name\> authentication rsa passphrase \<passphrase\>
...
set vpn ipsec site-to-site peer \<name\> authentication use-x509-id \<id\>
...
set vpn ipsec site-to-site peer \<name\> authentication x509 ca-certificate \<name\>
...
set vpn ipsec site-to-site peer \<name\> authentication x509 certificate \<name\>
...
set vpn ipsec authentication x509 passphrase \<passphrase\>
...
set vpn ipsec site-to-site peer \<name\> connection-type \<type\>
...
set vpn ipsec site-to-site peer \<name\> default-esp-group \<name\>
...
set vpn ipsec site-to-site peer \<name\> description \<description\>
...
set vpn ipsec site-to-site peer \<name\> dhcp-interface \<interface\>
...
set vpn ipsec site-to-site peer \<name\> force-udp-encapsulation
...
set vpn ipsec site-to-site peer \<name\> ike-group \<name\>
...
set vpn ipsec site-to-site peer \<name\> local-address \<address\>
...
set vpn ipsec site-to-site peer \<name\> remote-address \<address\>
...
set vpn ipsec site-to-site peer \<name\> replay-window \<size\>
...
set vpn ipsec site-to-site peer \<name\> virtual-address \<address\>
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> disable
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> esp-group \<name\>
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> priority \<number\>
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> protocol \<name\>
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> local prefix \<network\>
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> local port \<number\>
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> remote prefix \<network\>
...
set vpn ipsec site-to-site peer \<name\> tunnel \<number\> remote port \<number\>
...
set vpn ipsec site-to-site peer \<name\> vti bind \<interface\>
...
set vpn ipsec site-to-site peer \<name\> vti esp-group \<name\>
...
set vpn ipsec site-to-site peer \<name\> vti traffic-selector local prefix \<network\>
...
set vpn ipsec site-to-site peer \<name\> vti traffic-selector remote prefix \<network\>
...
reset vpn ipsec site-to-site peer \<name\>
...
reset vpn ipsec site-to-site peer \<name\> tunnel \<number\>
...
reset vpn ipsec site-to-site peer \<name\> vti \<number\>
...
- WAN interface on <span class="title-ref">eth0</span>
- <span class="title-ref">eth0</span> interface IP: <span class="title-ref">10.0.1.2/30</span>
- <span class="title-ref">dum0</span> interface IP: <span class="title-ref">192.168.0.1/24</span> (for testing purposes)
- Initiator

**PEER2:**

- WAN interface on <span class="title-ref">eth0</span>
- <span class="title-ref">eth0</span> interface IP: <span class="title-ref">10.0.2.2/30</span>
- <span class="title-ref">dum0</span> interface IP: <span class="title-ref">192.168.1.0/24</span> (for testing purposes)
- Responder
...
- WAN interface on <span class="title-ref">eth0</span>
- <span class="title-ref">eth0</span> interface IP: <span class="title-ref">10.0.1.2/30</span>
- 'vti0' interface IP: <span class="title-ref">10.100.100.1/30</span>
- <span class="title-ref">dum0</span> interface IP: <span class="title-ref">192.168.0.1/24</span> (for testing purposes)
- Role: Initiator
...
- WAN interface on <span class="title-ref">eth0</span>
- <span class="title-ref">eth0</span> interface IP: <span class="title-ref">10.0.2.2/30</span>
- 'vti0' interface IP: <span class="title-ref">10.100.100.2/30</span>
- <span class="title-ref">dum0</span> interface IP: <span class="title-ref">192.168.1.0/24</span> (for testing purposes)
- Role: Responder
