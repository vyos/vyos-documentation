...
Node-1@vyos:~$ show mpls table
 ...
 ----------------------------------------------------------------------
 552            SR (IS-IS)  192.0.2.2              IPv4 Explicit Null     <-- Prefix-SID for Node-2's loopback (SRGB 550 + index 2)
 15000          SR (IS-IS)  192.0.2.2              implicit-null          <-- Adj-SID, IPv4, unprotected
 15001          SR (IS-IS)  fe80::e87:6cff:fe09:1  implicit-null          <-- Adj-SID, IPv6, unprotected
 15002          SR (IS-IS)  192.0.2.2              implicit-null          <-- Adj-SID, IPv4, protected
 15003          SR (IS-IS)  fe80::e87:6cff:fe09:1  implicit-null          <-- Adj-SID, IPv6, protected
```
...
Node-2@vyos:~$ show mpls table
 Inbound Label  Type        Nexthop               Outbound Label
 ---------------------------------------------------------------------
 551            SR (IS-IS)  192.0.2.1             IPv4 Explicit Null     <-- Prefix-SID for Node-1's loopback (SRGB 550 + index 1)
 15000          SR (IS-IS)  192.0.2.1             implicit-null          <-- Adj-SID, IPv4, unprotected
 15001          SR (IS-IS)  fe80::e33:2ff:fe80:1  implicit-null          <-- Adj-SID, IPv6, unprotected
 15002          SR (IS-IS)  192.0.2.1             implicit-null          <-- Adj-SID, IPv4, protected
 15003          SR (IS-IS)  fe80::e33:2ff:fe80:1  implicit-null          <-- Adj-SID, IPv6, protected
```
