...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf authentication
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf bandwidth
   <number>
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf cost <number>
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf dead-interval
   <number>
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf hello-interval
   <number>
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf hello-multiplier
   <number>
   
   This command allows to set fast hello. If :cfgcmd:`hello-multiplier` is
   specified, then the dead-interval is set to 1 second and one must specify
   a hello-multiplier. The hello-multiplier specifies how many Hellos to
   send per second, from 2 (every 500ms) to 10 (every 100ms).

.. cfgcmd:: set protocols ospf interface <interface> ip ospf mtu-ignore
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf network <type>
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf priority
   <number>
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf
...
.. cfgcmd:: set protocols ospf interface <interface> ip ospf transmit-delay
   <number>
