...
Configure IP address of the DHCP <span class="title-ref">\<server\></span> which will handle the relayed
packets.
...
Set the maximum hop <span class="title-ref">\<count\></span> before packets are discarded. Range 0...255,
default 10.
...
Set maximum <span class="title-ref">\<size\></span> of DHCP packets including relay agent information. If a
...
set service dhcpv6-relay upstream-interface \<interface\>
address \<server\>

Specifies an upstream network <span class="title-ref">\<interface\></span> from which replies from
<span class="title-ref">\<server\></span> and other relay agents will be accepted.

</div>

<div id="dhcp-relay:ipv6_options">
...
- DHCPv6 requests are received by the router on <span class="title-ref">listening interface</span> `eth1`
- Requests are forwarded through `eth2` as the <span class="title-ref">upstream interface</span>
