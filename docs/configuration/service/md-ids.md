...
set service ids ddos-protection alert-script \<text\>
...
set service ids ddos-protection ban-time \<1-4294967294\>
...
set service ids ddos-protection direction \[in | out\]
...
set service ids ddos-protection exclude-network \<x.x.x.x/x\>

</div>

<div class="cfgcmd">

set service ids ddos-protection exlude-network \<h:h:h:h:h:h:h:h/x\>
...
set service ids ddos-protection listen-interface \<text\>
...
set service ids ddos-protection mode \[mirror | sflow\]
...
set service ids ddos-protection network \<x.x.x.x/x\>

</div>

<div class="cfgcmd">

set service ids ddos-protection network \<h:h:h:h:h:h:h:h/x\>
...
set service ids ddos-protection sflow listen-address \<x.x.x.x\>
...
set service ids ddos-protection sflow port \<1-65535\>
...
set service ids ddos-protection threshold general
...
set service ids ddos-protection threshold icmp
\[fps | mbps | pps\] \<0-4294967294\>
...
set service ids ddos-protection threshold tcp
\[fps | mbps | pps\] \<0-4294967294\>
...
set service ids ddos-protection threshold udp
\[fps | mbps | pps\] \<0-4294967294\>
