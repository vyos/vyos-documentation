...
set firewall flowtable \<flow_table_name\> interface \<iface\>
...
set firewall flowtable \<flow_table_name\> description \<text\>
...
set firewall flowtable \<flow_table_name\> offload
\<hardware | software\>
...
set firewall \[ipv4 | ipv6\] forward filter rule \<1-999999\>
action offload
