...
set firewall group address-group \<name\> address \[address |
address range\]
...
set firewall ipv4 \[forward | input | output\] filter rule
...
set firewall ipv4 name \<name\> rule \<1-999999\> add-address-to-group
...
set firewall ipv6 \[forward | input | output\] filter rule
\<1-999999\> add-address-to-group destination-address address-group \<name\>
...
set firewall ipv6 name \<name\> rule \<1-999999\> add-address-to-group
destination-address address-group \<name\>
