...
called Vyatta. [^footnote-1] 2006 onwards, it was a great free software
...
features and was only available to paying customers. [^footnote-2]
...
graphics and the trademark "VyOS". [^footnote-3] This means you can build your
...
[^footnote-2]: A business model comparable to that of Redis, rather than that
    of VyOS today.

[^footnote-3]: This is not unlike how Linus Torvalds owns the trademark "Linux".
