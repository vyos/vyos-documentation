...
called Vyatta.[1] 2006 onwards, it was a great free software
...
features and was only available to paying customers.[2]
...
[Sentrium SL](https://blog.vyos.io/sentrium-what-sentrium) was
...
cooler scheme of Latin names of [IAU](https://en.wikipedia.org/wiki/IAU_designated_constellations_by_area)
...
graphics and the trademark "VyOS".[3] This means you can build your
...
[1] From the Sanskrit adjective "Vyātta" (व्यात्त), meaning opened.

[2] A business model comparable to that of Redis, rather than that
of VyOS today.

[3] This is not unlike how Linus Torvalds owns the trademark "Linux".
