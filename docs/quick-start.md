...
After switching to `quick-start-configuration-mode` issue the following
commands:
...
connections. You might want to check the `ssh` chapter on how to listen
...
The following settings will configure `source-nat` rules for our
