...
.. grid:: 3
   ...
   .. grid-item-card:: Get / Build VyOS
      ...
      Quickly :ref:`Build<contributing/build-vyos:build_vyos>` your own Image
   ...
   .. grid-item-card:: Configuration and Operation
      ...
      Use the :ref:`Quickstart Guide<quick-start:Quick Start>`, to have a fast
       overview. Or go deeper and
   ...
   .. grid-item-card:: Automate
      ...
      have your own :ref:`local scripts<command-scripting>`, or configure VyOS
       with the :ref:`HTTPS-API<vyosapi>`.
