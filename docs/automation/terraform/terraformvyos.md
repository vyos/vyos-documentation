...
For more details about Terraform please have a look here [link](https://developer.hashicorp.com/terraform/intro).

Need to [install](https://developer.hashicorp.com/terraform/tutorials/aws-get-started/install-cli) Terraform
