...
VyOS supports op-mode and configuration via [salt](https://docs.saltproject.io/en/latest/contents.html).
...
It is possible to configure VyOS via [netmiko](https://docs.saltproject.io/en/latest/ref/modules/all/salt.modules.netmiko_mod.html#module-salt.modules.netmiko_mod) proxy module.
